...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/SKOOLBUBBLE/assets/images/profile_pics';
	//Set File name	
...
***********************************************************/		
		...
		// Specify The new size
			$main_width = 450; // set the width of the image
		...
		//create new image using correct php func			
			...
			elseif($_FILES["image"]["type"] == "image/jpeg" ||  $_FILES["image"]["type"] == "image/pjpg"){
